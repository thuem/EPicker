...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--data', help='the path of data')
        self.parser.add_argument('--label', help='the path of label')
        self.parser.add_argument('--mode', default='particle',
                                 help='particle | vesicle | fiber')
        self.parser.add_argument('--output', help='the path of outputs', default='./output')
        self.parser.add_argument('--output_type', help='thi | star | box | coord', default='thi')
        self.parser.add_argument('--visual', help='save png files for visualization', action='store_true')
        self.parser.add_argument('--edge', help='restrict ROI', default=25, type=int)
        self.parser.add_argument('--min_distance', help='minimum distance of particles', default=0, type=int)
        self.parser.add_argument('--train_pct', default=100, type=int)
        self.parser.add_argument('--val_pct', default=0, type=int)
        self.parser.add_argument('--test_pct', default=0, type=int)
        self.parser.add_argument('--label_type', default='thi',
                                 help='star | box | coord | thi')
        self.parser.add_argument('--data_type', default='mrc')
        self.parser.add_argument('--load_exemplar', help='the path to the original exemplar dataset',
                                 default='./exemplar_dataset')
        self.parser.add_argument('--output_exemplar', help='the path to save the new exemplar dataset',
                                 default='./exemplar_dataset')
        self.parser.add_argument('--sampling_size', default=200, type=int)
        ...
        self.parser.add_argument('--ang_thresh', default=0.3, type=float)
        self.parser.add_argument('--task', default='ctdet',
                                 help='ctdet | ddd | multi_pose | exdet')
        self.parser.add_argument('--dataset', default='particle')
        self.parser.add_argument('--exp_id', default='default')
        self.parser.add_argument('--test', action='store_true')
        self.parser.add_argument('--save_debug_files', action='store_true')
        ...
        self.parser.add_argument('--pretrained_model', default=None)
        self.parser.add_argument('--resume', action='store_true',
                                 help='resume an experiment. '
                                      'Reloaded the optimizer parameter and '
                                      'set load_model to model_last.pth '
                                      'in the exp dir if load_model is empty.')
        self.parser.add_argument('--continual', action='store_true',
                                 help='Continual learning method.')
        self.parser.add_argument('--sparse_anno', action='store_true',
                                 help='Sparse annotation')
    ...
    def parse(self, args=''):
        ...
        if opt.pretrained_model == None:
            ...
            # opt.pretrained_model = os.path.join(home, '.torch/models/dla34-ba72cf86.pth')
            opt.pretrained_model = os.path.join(__file__.replace('opts.py', ''), '../model/dla34-ba72cf86.pth')
